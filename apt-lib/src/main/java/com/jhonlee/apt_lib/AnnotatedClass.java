...
class AnnotatedClass {
    ...
    private static class TypeUtil {
        static final ClassName BINDER = ClassName.get("com.jhonlee.bindlibrary", "ViewBinder");
        static final ClassName PROVIDER = ClassName.get("com.jhonlee.bindlibrary", "ViewFinder");
    }
